...
PY_CODE="${MYDIR}/../py/create_table.py"
...
--name CreateTablePy $PY_CODE --src s3a://spark-sapp/data/city_temperature.csv  --bucket spark-sapp --database sapp --table t1 --datamartFolder /warehouse/sapp.db \
--select "$SELECT"
